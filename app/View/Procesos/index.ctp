<div class="procesos index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $proceso['Proceso']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $proceso['Proceso']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $proceso['Proceso']['id']), null, __('Are you sure you want to delete # %s?', $proceso['Proceso']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
