...
<?php echo $this->Form->create('Proceso'); ?>
	<fieldset>
		<legend><?php echo __('Edit Proceso'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Proceso.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Proceso.id'))); ?></li>
