<div class="partidas index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('enero_monto'); ?></th>
         	<th><?php echo $this->Paginator->sort('enero_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('enero_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('enero_propio'); ?></th>
            <th><?php echo $this->Paginator->sort('febrero_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('febrero_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('febrero_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('febrero_propio'); ?></th>
			<th><?php echo $this->Paginator->sort('marzo_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('marzo_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('marzo_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('marzo_propio'); ?></th>
			<th><?php echo $this->Paginator->sort('abril_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('abril_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('abril_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('abril_propio'); ?></th>
			<th><?php echo $this->Paginator->sort('mayo_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('mayo_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('mayo_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('mayo_propio'); ?></th>
			<th><?php echo $this->Paginator->sort('junio_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('junio_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('junio_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('junio_propio'); ?></th>
			<th><?php echo $this->Paginator->sort('julio_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('julio_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('julio_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('julio_propio'); ?></th>
			<th><?php echo $this->Paginator->sort('agosto_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('agosto_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('agosto_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('agosto_propio'); ?></th>
			<th><?php echo $this->Paginator->sort('septiembre_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('septiembre_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('septiembre_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('septiembre_propio'); ?></th>
			<th><?php echo $this->Paginator->sort('octubre_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('octubre_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('octubre_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('octubre_propio'); ?></th>
			<th><?php echo $this->Paginator->sort('noviembre_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('noviembre_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('noviembre_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('noviembre_propio'); ?></th>
			<th><?php echo $this->Paginator->sort('diciembre_monto'); ?></th>
			<th><?php echo $this->Paginator->sort('diciembre_federal'); ?></th>
			<th><?php echo $this->Paginator->sort('diciembre_estatal'); ?></th>
			<th><?php echo $this->Paginator->sort('diciembre_propio'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($partida['Partida']['enero_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['enero_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['enero_propio']); ?>&nbsp;</td>
        <td><?php echo h($partida['Partida']['febrero_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['febrero_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['febrero_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['febrero_propio']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['marzo_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['marzo_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['marzo_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['marzo_propio']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['abril_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['abril_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['abril_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['abril_propio']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['mayo_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['mayo_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['mayo_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['mayo_propio']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['junio_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['junio_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['junio_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['junio_propio']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['julio_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['julio_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['julio_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['julio_propio']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['agosto_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['agosto_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['agosto_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['agosto_propio']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['septiembre_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['septiembre_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['septiembre_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['septiembre_propio']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['octubre_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['octubre_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['octubre_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['octubre_propio']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['noviembre_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['noviembre_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['noviembre_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['noviembre_propio']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['diciembre_monto']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['diciembre_federal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['diciembre_estatal']); ?>&nbsp;</td>
		<td><?php echo h($partida['Partida']['diciembre_propio']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Ver'), array('action' => 'view', $partida['Partida']['id'])); ?>
			<?php echo $this->Html->link(__('asignar presupuesto'), array('action' => 'edit', $partida['Partida']['id'])); ?>
